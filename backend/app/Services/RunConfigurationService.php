    ...
    private function allowedKeys(string $protocol): array
    {
        return match ($protocol) {
            'http' => [
                ...
                'retry_attempts',
                'retry_delay_ms',
                'simulate_timeout_on_sequences',
                'simulate_connection_failure_on_sequences',
                'scenario',
            ],
            'mqtt' => [
                'host',
    ...
    private function rules(string $protocol): array
    {
        return match ($protocol) {
            'http' => [
                ...
                'simulate_timeout_on_sequences' => ['nullable', 'array'],
                'simulate_timeout_on_sequences.*' => ['integer', 'min:1'],
                'simulate_connection_failure_on_sequences' => ['nullable', 'array'],
                'simulate_connection_failure_on_sequences.*' => ['integer', 'min:1'],
